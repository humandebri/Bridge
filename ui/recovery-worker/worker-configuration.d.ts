/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=recovery-worker/wrangler.jsonc --strict-vars=false recovery-worker/worker-configuration.d.ts` (hash: 2020cef3059e97ed617a9d3d3877f156)
// Runtime types generated with workerd@1.20260722.1 2026-09-10
interface __BaseEnv_Env {
  IP_LIMIT: RateLimit
  DEPOSIT_LIMIT: RateLimit
  RECOVERY_ENABLED: string
  ALCHEMY_API_KEY: string
  CURSOR_KEY: string
  BRIDGE_PROFILE_JSON: string
}

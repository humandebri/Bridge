...
export function persistRiskAcknowledgement(storage?: Pick<Storage, "setItem">): void {
  try {
    ...
    /* Continue for this page load; a future load will ask again. */
  }
}
    ...
    <Dialog open onOpenChange={() => undefined}>
      <DialogContent dismissible={false} className="max-w-[520px] p-5 sm:p-7">
        <DialogHeader className="pr-0">
          ...
          <DialogDescription>
            This bridge has not been audited. Bugs or attacks may result in the partial or total
            loss of funds. Use at your own risk.
          </DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter>
          <Button className="w-full sm:w-auto" disabled={!checked} onClick={acknowledge}>

...
for (const key of ["environmentMode", "activationTimelockDelaySeconds", "bridgeCanisterId", "deploymentInstanceId", "ledgerCanisterId", "indexCanisterId", "bridgeAddress", "bsnsAddress", "timelockAddress", "expected_bridge_signer", "bridgeRuntimeHash", "bsnsRuntimeHash", "rpcProviderUrlsSha256", "deploymentBlock"]) {

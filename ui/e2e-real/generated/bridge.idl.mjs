...
export const idlFactory = ({ IDL }) => {
  ...
  const EvmFeeQuoteStatus = IDL.Record({
    'reserved_l1_fee_wei' : IDL.Nat,
    'observed_l1_fee_upper_bound_wei' : IDL.Nat,
    'base_fee_per_gas' : IDL.Nat,
    'max_priority_fee_per_gas' : IDL.Nat,

...
for (const mutate of [
  ...
  (value) => { delete value.before.public_config.notification_ingestion_rate_limit_global; delete value.after.public_config.notification_ingestion_rate_limit_global },

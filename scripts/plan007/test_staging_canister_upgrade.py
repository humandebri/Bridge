#!/usr/bin/env python3
"""Regression tests for the fail-closed staging v33-to-v36 upgrade gate."""
...
class V33ToV36UpgradeTests(unittest.TestCase):
    def setUp(self) -> None:
...
''')
    ...
    def test_preflight_is_read_only_and_records_atomic_counts(self) -> None:
        ...
        self.assertIn('migration_id = opt "bridge-staging-v33-to-v36"', evidence["upgrade_arguments"])

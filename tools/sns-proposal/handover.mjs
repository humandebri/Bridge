...
export function registrationProposal(bridgeText) {
  ...
  return `record {title="Register KINIC Bridge with SNS"; url=""; summary="Register the Bridge after the production identity and SNS Root have been verified as co-controllers. Successful registration removes the personal controller."; action=opt variant {RegisterDappCanisters=record {canister_ids=vec {principal "${bridge}"}}}}`;
}

...
pub use kernel::{
    ...
    resources_sufficient, restored_pending_blocked, runtime_attestation_matches, scan_complete,
    ...
    withdrawal_phase_step, withdrawal_transition_effects, DepositAdmissionDecision, DepositEffects,
    DepositEventGuard, DepositIdentityDecision, DepositTransitionDecision, DepositTransitionInput,

...
pub use kernel::{
    ...
    reserve_admission_preserves_requirement, resources_sufficient, restored_pending_blocked,
    scan_complete, service_fee_change_allowed, settlement_decision, signature_install_allowed,
    withdrawal_finalization_decision, withdrawal_liability_indexed, withdrawal_phase_allows,
    withdrawal_phase_step, DepositAdmissionDecision, DepositEffects, DepositEventGuard,

...
pub use kernel::{
    ...
    canonical_probe_matches, checked_counter_transition, checked_requirement,
    committed_quote_matches, confirmation_caller_authorized, confirmation_roles_distinct,
    counter_delta, deposit_admission_decision, deposit_charge_service_fee,
    deposit_continuation_decision, deposit_identity_decision, deposit_ledger_block_transition,
    ...
    withdrawal_finalized_identity_quorum, withdrawal_id_is_admissible,
    withdrawal_ledger_block_transition, withdrawal_liability_indexed, withdrawal_phase_allows,
    withdrawal_phase_step, withdrawal_transition_effects, AssetOperationLifecycleDecision,
    BootstrapPausePrincipalMigrationDecision, DepositAdmissionDecision,
    DepositContinuationDecision, DepositEffects, DepositEventGuard, DepositIdentityDecision,
    DepositTransitionDecision, DepositTransitionInput, FeeRecipientRotationDecision,
    FundingAttemptDecision, FundingReconciliationDecision, HoldResolutionDecision,
    LeaseLaneClaimDecision, LeaseOutcomeDecision, LegacyActivationEvidenceRequirement,
    ManualClaimDecision, OperationalConfigSealDecision, PayoutDecision,
    RefundRequestIdentityDecision, ReservationDecision, SettlementDecision,

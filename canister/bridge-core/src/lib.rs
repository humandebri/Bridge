...
pub use kernel::{
    ...
    deposit_charge_service_fee, deposit_continuation_decision, deposit_identity_decision,
    ...
    withdrawal_phase_step, withdrawal_transition_effects, DepositAdmissionDecision,

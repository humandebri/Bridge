...
schema v35再オープンとwire v30をRust transaction testとsame-Wasm PocketIC testで検証する。Productionとtest-deploymentはいずれも旧・未知schemaをfail closedにし、既存stagingは同一deployment instanceのcurrent-schema upgradeだけを受理する。

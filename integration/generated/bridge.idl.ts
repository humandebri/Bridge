...
export const idlFactory = ({ IDL }: Parameters<import("@icp-sdk/core/candid").IDL.InterfaceFactory>[0]) => {
  ...
  const BridgeInitArgs = IDL.Record({
    ...
    'notification_rate_limit_global' : IDL.Nat16,
    ...
    'notification_rate_limit_window_seconds' : IDL.Nat64,
    'settlement_rate_limit_window_seconds' : IDL.Nat64,
    'ecdsa_derivation_path' : IDL.Vec(IDL.Vec(IDL.Nat8)),
    'notification_ingestion_rate_limit_global' : IDL.Nat16,
  ...
  const SettlementStopReason = IDL.Variant({
    ...
    'AuthorizationWindowTooShort' : IDL.Null,
  ...
  const ControlPlaneAddressesView = IDL.Record({
    'independent_canceller' : IDL.Vec(IDL.Nat8),
    'bridge_signer' : IDL.Vec(IDL.Nat8),
    'runtime_administrator' : IDL.Vec(IDL.Nat8),
    'governance_operator' : IDL.Vec(IDL.Nat8),
  });
  const ControlPlaneAddressesError = IDL.Variant({
  ...
  const ListWithdrawalsArgs = IDL.Record({
    'requester' : IDL.Vec(IDL.Nat8),
    'limit' : IDL.Nat16,
    'before_cursor' : IDL.Opt(IDL.Vec(IDL.Nat8)),
  });
  const WithdrawalHistoryView = IDL.Record({
    'transaction_hash' : IDL.Opt(IDL.Vec(IDL.Nat8)),
    'requester' : IDL.Vec(IDL.Nat8),
    'owner' : IDL.Principal,
    'observed_at_ns' : IDL.Nat64,
  ...
  const WithdrawalHistoryPage = IDL.Record({
    'history_truncated' : IDL.Bool,
    'next_cursor' : IDL.Opt(IDL.Vec(IDL.Nat8)),
    'items' : IDL.Vec(WithdrawalHistoryView),
  });
  const ListWithdrawalsError = IDL.Variant({
    'InvalidRequester' : IDL.Null,
  ...
  const Result_20 = IDL.Variant({ 'Ok' : IDL.Null, 'Err' : AdminError });
  ...
  return IDL.Service({
    ...
    'get_control_plane_addresses' : IDL.Func([], [Result_9], ['query']),
    ...
    'get_operational_config' : IDL.Func([], [Result_10], ['query']),
    ...
    'initialize_public_config' : IDL.Func([], [Result_14], []),
    'list_deposit_ids' : IDL.Func([ListDepositIdsArgs], [Result_15], ['query']),
    ...
    'notify_deposit_mint' : IDL.Func([NotifyDepositMintArgs], [Result_18], []),
    'notify_withdrawal' : IDL.Func([NotifyWithdrawalArgs], [Result_19], []),
    'pause_new_deposits' : IDL.Func([], [Result_20], []),
    ...
    'refresh_storage_checksum' : IDL.Func([IDL.Nat64], [Result_21], []),
    'request_deposit' : IDL.Func([DepositArgs], [Result_22], []),
    'request_deposit_refund' : IDL.Func([IDL.Vec(IDL.Nat8)], [Result_23], []),
    'request_fee_payout' : IDL.Func([IDL.Nat], [Result_24], []),
    'rotate_fee_recipient' : IDL.Func([FeeRecipientConfig], [Result_20], []),
    ...
    'storage_integrity_check' : IDL.Func([], [Result_26], ['query']),
  });
};
